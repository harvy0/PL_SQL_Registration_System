...
--------------------------------------------------------
 ...
 BEGIN
  ...
  dbms_output.put_line('Student ID: ' || r_student.s_id || ', Name: ' || r_student.fname || ', Grade: ' || r_student.grade 
                      || ', Fees Amount: ' || r_student.amount || ', Course Name:  ' || r_student.course_name || ', Instructor Name: ' || r_student.f_fname);
